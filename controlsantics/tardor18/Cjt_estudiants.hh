...
private:
  ...
  static const int MAX_NEST = 2500005; // nombre maxim d'estudiants del conjunt
...
public:
  ...
  void unir_conjunts(const Cjt_estudiants & c);
  
  void actualitzar_conjunt();
  ...
  void llegir();
  /* Pre: el canal estàndar d'entrada conté un enter positiu n seguit de 
     n descripcions d'estudiants, i.e. parells (dni, nota), ordenats 
      creixentment per dni */
