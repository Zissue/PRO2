...
public:
    ...
    /** @brief Creadora por defecto. 
      ...
      Se ejecuta automáticamente al declarar una BinTree.
      \pre <em>cierto</em>
      \post El resultado es BinTree de tipo T.
  */
    // Constructs an empty tree. Θ(1).
    BinTree ()
    :   p(nullptr)
    {   }
    /** @brief Modificadora de la nota, para estudiantes sin nota\pre El par ́ametro impl ́ıcito no tiene nota, nota es una nota v ́alida\post La nota del par ́ametro impl ́ıcito pasa a ser nota<*/
